...
export default function CardComponents() {
    const courses = [
        { image: "https://static.tildacdn.one/tild3562-6262-4663-b230-333563336163/4.png", title: "     Frontend    ", description: "Web dasturlashda dastalabki qadamlar", mentor: "Habibulloh Nuriddinov", mentorImage: "https://i.pravatar.cc/32?img=1" },
        { image: "https://static.tildacdn.one/tild3465-3462-4234-b433-383766656436/1.png", title: "     Backend      ", description: "Server dasturlash asoslari", mentor: "Shoxrux Abduraxmonov", mentorImage: "https://i.pravatar.cc/32?img=2" },
            ...
            <div className="max-w-7xl mx-auto p-4 ">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 ">
                    {courses.map((course, index) => (
                        <div key={index} className="bg-white rounded-[50px] justify-center py-5  flex h-[300px] items-center gap-4  hover:shadow-lg transition-shadow duration-300 relative">
                            <div className="w-[280px] bg-gradient-to-br from-blue-600 via-purple-600 to-blue-800 rounded-[18px] flex items-center justify-center h-full transition-all duration-300 relative">
                                <img src={course.image} alt={course.title} className="w-64 h-34 object-contain p-2 transform transition-transform duration-300 group-hover:translate-x-1/2 group-hover:-translate-y-1/2 absolute -bottom-2 -right-15" />
                            </div>
