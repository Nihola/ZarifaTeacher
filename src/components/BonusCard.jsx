    ...
    <div className="max-w-7xl mx-auto p-4 xl:p-6 max-sm:pt-10">
        ...
        {/* Card Section */} <section className="bg-white rounded-2xl shadow-lg overflow-hidden flex flex-col md:flex-row items-center hover:shadow-2xl hover:-translate-y-1 transition-all duration-500">
            ...
            <div className="w-full md:w-1/2 p-6 flex flex-col gap-4">
                ...
                <p className="text-gray-600 text-sm md:text-base">{t("bonus.desc")}</p>
        ...
        {isOpen && (
            <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex justify-center items-center z-50 px-4">
                <div className="bg-white rounded-2xl shadow-2xl max-w-lg w-full p-6 animate-fadeIn relative">
                    ...
                    <p className="text-gray-600 mb-4">{t("bonus.modalDesc")}</p>
                    ...
                    <p className="text-xs text-gray-500 mt-3">{t("bonus.note")}</p>
                </div>
            </div>
        )}
    </div>
